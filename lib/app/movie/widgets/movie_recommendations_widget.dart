...
class MovieRecommendationsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _recommendations =
        context.select((MoviePageModel model) => model.recommendations);
...
class _HorizontalScrollMoviesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _movies =
        context.select((MoviePageModel model) => model.recommendations!.movies);
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Padding(
            ...
            child: _RecommendedMovieCardWidget(
...
class _RecommendedMovieCardWidget extends StatelessWidget {
  final Movie movie;
  final void Function(int) handleTap;

  const _RecommendedMovieCardWidget({
    Key? key,
    required this.movie,
